...
var FS = {
  ...
  startGet: function () {
    if (FS.id.length > 0) {
      window.location = FS.urlPhoto + "https://www.facebook.com/profile.php?id=" + FS.id + "&sk=photos";
    } else {
      window.location = "https://www.facebook.com/" + FS.username + "?sk=photos";
    }
  },
  Show: function () {
    var block = document.getElementById('ImageView');
    block.innerHTML = "";
    var cont = new Array();
  ...
  init: function (id) {
    ...
    if (FS.local.indexOf("facebook") > 0) {
      ...
      if (FS.local.indexOf("sk=photos") > 0) {
        html += "<a style='border: solid 1px gray; padding: 3px; background: #EEEEEE; width: 180px; display:block' onclick='FS.openAllAnbum()' href='javascript:void(0);'> Open all albums</a>";
        html += "&nbsp&nbsp&nbsp<a style='border: solid 1px gray; padding: 3px; background: #EEEEEE; width: 180px; display:block' onclick='FS.displayInfo(FS.getThumbPics())' href='javascript:void(0);'> Display all link</a>";
      } else if (FS.local.indexOf("media/set/") > 0) {
        html += "<a style='border: solid 1px gray; padding: 3px; background: #EEEEEE; width: 180px; display:block' onclick='FS.displayInfo(FS.getThumbPics())' href='javascript:void(0);'> Display all link</a>";
      } else {
        html += "<a style='border: solid 1px gray; padding: 3px; background: #EEEEEE; width: 180px; display:block' onclick='FS.startGet()' href='javascript:void(0);'> Lay link anh</a>";
      }
      ...
      if (show === true) {
        html += "<a style=\"border: solid 1px gray; padding: 3px; background: #EEEEEE; width: 180px; display:block\" onclick=\"FS.displayInfo(FS.getPicasa('s640'))\" href=\"javascript:void(0);\"> Display all link Size 640px</a>";
        html += "<br/><a style=\"border: solid 1px gray; padding: 3px; background: #EEEEEE; width: 180px; display:block\" onclick=\"FS.displayInfo(FS.getPicasa('s720'))\" href=\"javascript:void(0);\"> Display all link Size 720px</a>";
        html += "<br/><a style=\"border: solid 1px gray; padding: 3px; background: #EEEEEE; width: 180px; display:block\" onclick=\"FS.displayInfo(FS.getPicasa('s1024'))\" href=\"javascript:void(0);\"> Display all link Size 1024px</a>";
        html += "<br/><a style=\"border: solid 1px gray; padding: 3px; background: #EEEEEE; width: 180px; display:block\" onclick=\"FS.displayInfo(FS.getPicasa('s2048'))\" href=\"javascript:void(0);\"> Display all link Full size</a>";
      } else {
        div.style.display = "none";
      }
    } else if (FS.local.indexOf("flickr") > 0) {
      html += "<br/><a style=\"border: solid 1px gray; padding: 3px; background: #EEEEEE; width: 180px; display:block\" onclick=\"FS.displayInfo(FS.getFlickr('.jpg'))\" href=\"javascript:void(0);\"> Display all link Size 500px</a>";
      html += "<a style=\"border: solid 1px gray; padding: 3px; background: #EEEEEE; width: 180px; display:block\" onclick=\"FS.displayInfo(FS.getFlickr('_z.jpg'))\" href=\"javascript:void(0);\"> Display all link Size 640px</a>";
      html += "<br/><a style=\"border: solid 1px gray; padding: 3px; background: #EEEEEE; width: 180px; display:block\" onclick=\"FS.displayInfo(FS.getFlickr('_b.jpg'))\" href=\"javascript:void(0);\"> Display all link Size 1024px</a>";
    } else if (FS.local.indexOf("photobucket.com") > 0) {
      html += "<br/><a style=\"border: solid 1px gray; padding: 3px; background: #EEEEEE; width: 180px; display:block\" onclick=\"FS.displayInfo(FS.getBucket('mini'))\" href=\"javascript:void(0);\"> Display all link smale Size</a>";
      html += "<br/><a style=\"border: solid 1px gray; padding: 3px; background: #EEEEEE; width: 180px; display:block\" onclick=\"FS.displayInfo(FS.getBucket('full'))\" href=\"javascript:void(0);\"> Display full Size</a>";
    }
    html +="</div>";
    div.innerHTML = html;
  }
